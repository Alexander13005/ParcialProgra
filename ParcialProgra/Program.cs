                            ...
                            switch (men1)
                            {
                                ...
                                case ("4"):
                                    ...
                                    if (comb1 == 4)
                                    {
                                        Console.WriteLine("¿Cantidad a ordenar?");
                                        cant = int.Parse(Console.ReadLine());
                                        Console.WriteLine("Usted ha ordenado el aperitivo número" + " " + comb1 + " " + "y su precio es de " + "$" + (10.00 * cant));
                                        preciofinal = preciofinal + (10.00 * cant);
                                        Console.WriteLine("¿Desea ordenar algo más?");
                                        p = Console.ReadLine();
                                    }
                ...
                switch (ham)
                {
                    ...
                    case ("4"):
                        while (p == "Si")
                        {
                            ...
                            Console.WriteLine();
                            Console.WriteLine("Bienvenido al menú de El Zocalo, ¿Qué desea ordenar?");
                    ...
                    case ("5"):
                        while (p == "Si")
                        {
                            ...
                            Console.WriteLine();
                            Console.WriteLine("Bienvenido al menú de Taqueria la 20, ¿Qué desea ordenar?");
